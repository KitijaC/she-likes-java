...
public class DictionaryProgram {
    public static void main(String[] args) {
        ...
        System.out.println("type 1 for English - Czech");
...
//        String userChoice = console.readLine();
        ...
        if (userChoice.equals("1")) {
            currentDictionary = MyDictionaries.createEnglishCzechDictionary();
            System.out.println("let's use English - Czech dictionary");
