...
public class ListSecondExample {
    public static void main(String[] args) {
        ...
        List<String> anotherList = names; // points to the same list
        // you cannot add element at nonexistent index
//        names.add(3000, "Agnese F.");
        ...
        System.out.println("Persons with the name Johny: " + foundPersons);
