...
public class IncrementationDecrementationExamples {
    public static void main(String[] args) {
        ...
        int three = ++one;
        System.out.println("one value is: " + one);
        System.out.println("three should have value of 13, and current value os it is: " + three);
        ...
        System.out.println("one value is: " + one);
        System.out.println("four value is: " + four);
        System.out.println("preincrementation - first increment, later use new value in assignment expression");
